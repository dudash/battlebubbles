...
{
    /// <summary>
    /// A circular bound version of the abstract board obstruction class
    /// </summary>
    [Serializable]
    public class ObstructionCircle : Obstruction
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="bounds"></param>
        public ObstructionCircle(Vector2 centerPoint, float radius)
        {
