...
namespace HBBB.GameComponents.Menus
{
    ...
    /// </summary>
    class Options2Menu : BaseMenu
    {
        private static string MENU_ID = "OPTIONS_2_MENU";
...
//        bool showStartToStart = false;
        ...
        public Options2Menu(Game game, BaseMenuSystem parentSystem)
        ...
        {
            base.LoadContent();
            backgroundTexture = content.Load<Texture2D>(@"W_A_D\Textures\menus\instructions_menu_2");
//            startToStartTexture = content.Load<Texture2D>(@"W_A_D\Textures\Buttons\button_back");
        ...
        public override void OnButtonClick(PlayerIndex index, GamePadButtonEventDetails details)
        {
                ...
                details.Button == GamePadWrapper.ButtonId.B)
            {
                ...
                details.Button == GamePadWrapper.ButtonId.RIGHT_SHOULDER)
            {
                GameAudio.PlayCue("click");
                parentSystem.TransitionToMenu(Options3Menu.MenuId);
            }
