...
namespace HBBB.GameComponents.Menus
{
    ...
    {
        private static string MENU_ID = "OPTIONS_MENU";
        ...
        public OptionsMenu(Game game, BaseMenuSystem parentSystem)
        ...
        {
            base.LoadContent();
            backgroundTexture = content.Load<Texture2D>(@"W_A_D\Textures\menus\instructions_menu_1");
