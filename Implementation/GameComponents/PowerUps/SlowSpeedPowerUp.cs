...
{
    /// <summary>
    /// Derived from PowerUp, this class slows the affected players speed, making it 
    /// difficult from him to move around the board.
    /// </summary>
    class SlowSpeedPowerUp : PowerUp
    {
        ...
        public SlowSpeedPowerUp(int id, Vector2 position)
            : base(id, position)
        {
            this.Texture = PowerUpFactory.GetTexture(PowerUpFactory.PowerUpId.POWERUP_SLOW_SPEED);
            isPositive = false;
        }
        ...
        public override void Execute(Board board, ref Player affectedPlayer, ref Slot affectedSlot)
        {
            ...
            affectedPlayer.MovementType = Player.PlayerMovementType.SLOW_MOVEMENT;
