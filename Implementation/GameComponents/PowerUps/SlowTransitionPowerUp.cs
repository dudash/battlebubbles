...
{
    /// <summary>
    /// Derived from PowerUp, this class slows the time it takes a player to 
    /// transition into a solid.
    /// </summary>
    class SlowTransitionPowerUp : PowerUp
    {
        ...
        public SlowTransitionPowerUp(int id, Vector2 position)
            : base(id, position)
        {
            this.Texture = PowerUpFactory.GetTexture(PowerUpFactory.PowerUpId.POWERUP_SLOW_TRANSITION);
            isPositive = false;
        }
        ...
        public override void Execute(Board board, ref Player affectedPlayer, ref Slot affectedSlot)
        {
            ...
            affectedPlayer.TimeRequiredToTransitionToSolid *= 4.0f; // 4 times as long
        ...
        {
            // TODO see if this should actually revert, there could be 2 slow speeds being applied
